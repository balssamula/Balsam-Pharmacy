...
def show():
    ...
    additions_df = exclude_old_items(additions_df)
    returns_df = exclude_old_items(returns_df)
    orphan_salla_df = exclude_old_items(orphan_salla_df)
    orphan_abc_df = exclude_old_items(orphan_abc_df)
